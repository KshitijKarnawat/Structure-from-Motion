 ...
 * @file calibrate.py
 * @author Hritvik Choudhari (hacj@umd.edu)
...
def load_point_clouds(voxel_size=0.000001):
    pcds = []
    for i in range(2,6,2):
        pcd = o3d.io.read_point_cloud(r"C:\Users\hritv\Desktop\Spring 23\Perception\Final project\Structure-from-Motion-devel\PCs\new_PC{}.pcd".format(i))
